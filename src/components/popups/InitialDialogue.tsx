...
export default function InitialDialogue() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const apiKeyInput = form.elements.namedItem("api-key") as HTMLInputElement;
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">
                To use all features, please provide your API key. For now it
                will be stored in your browser's local storage as Color Space is
                still in the improvement phase but will be changed to a more
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex gap-2">
                <input
                  ...
                  id="api-key"
                  name="api-key"
                  className={`w-full rounded-md border bg-neutral-800 px-3 py-2 text-gray-100 focus:outline-none ${
                    error
                      ? "border-red-500 focus:border-red-500"
                      : "border-gray-600 focus:border-neutral-500"
                  }`}
